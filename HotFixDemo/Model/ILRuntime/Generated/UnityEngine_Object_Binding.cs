...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Object_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(Cinemachine.CinemachineSmoothPath)};
            if (genericMethods.TryGetValue("FindObjectsOfType", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(Cinemachine.CinemachineSmoothPath[]), typeof(System.Boolean)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* FindObjectsOfType_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.Object.FindObjectsOfType<Cinemachine.CinemachineSmoothPath>(@includeInactive);
