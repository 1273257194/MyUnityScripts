...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Cysharp_Threading_Tasks_UniTask_Binding_Awaiter_Binding
    {
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            Cysharp.Threading.Tasks.UniTask.Awaiter instance_of_this_method = (Cysharp.Threading.Tasks.UniTask.Awaiter)typeof(Cysharp.Threading.Tasks.UniTask.Awaiter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
