...
namespace ILRuntime.Runtime.Generated
{
    unsafe class BestHTTP_HTTPRequest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_Response_0);


        }


        static StackObject* get_Response_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
