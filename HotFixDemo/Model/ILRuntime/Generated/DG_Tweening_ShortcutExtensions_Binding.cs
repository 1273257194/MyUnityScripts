...
namespace ILRuntime.Runtime.Generated
{
    unsafe class DG_Tweening_ShortcutExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UnityEngine.Camera), typeof(UnityEngine.Color), typeof(System.Single)};
        ...
        static StackObject* DOColor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = DG.Tweening.ShortcutExtensions.DOColor(@target, @endValue, @duration);
